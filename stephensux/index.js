...
const monsterImgs = ['https://i.ibb.co/5Tb2wDd/monster.png']
...
function fireLaser() {
  ...
  let laserSFX = new Audio('audio/audio_laser-sfx.m4a')
  laserSFX.play()
  moveLaser(laser)
}
...
function gameOver() {
  ...
  justice.pause()
  let gameOverSfx = new Audio('audio/audio_game-over.m4a')
  gameOverSfx.play()
  ...
  setTimeout(() => {
    alert(`Game Over! You couldn't stop Stephen. Your final score is 560075`)
...
function playGame() {
  ...
  justice = new Audio("audio/gameon.mp3")
  justice.play()
